package ch.kabashi.janie.MyToDo.security;
...
public class AuthenticationRoleConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    private static Collection<? extends GrantedAuthority> extractResourceRoles(final Jwt jwt) {
        ...
        if (resourceAccess != null) {
            Map<String, Collection<String>> mytodo = (Map<String, Collection<String>>) resourceAccess.get("mytodo");
          if ((resourceRoles = mytodo.get("roles")) != null) {
